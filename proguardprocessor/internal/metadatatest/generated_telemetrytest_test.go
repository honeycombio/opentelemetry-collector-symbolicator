...
func TestSetupTelemetry(t *testing.T) {
	...
	defer tb.Shutdown()
	tb.ProcessorProguardCacheSize.Record(context.Background(), 1)
	...
	tb.ProcessorTotalProguardFetchFailures.Add(context.Background(), 1)
	AssertEqualProcessorProguardCacheSize(t, testTel,
	...
	AssertEqualProcessorTotalProcessedFrames(t, testTel,
		[]metricdata.DataPoint[int64]{{Value: 1}},
		metricdatatest.IgnoreTimestamp())
	AssertEqualProcessorTotalProguardFetchFailures(t, testTel,
		[]metricdata.DataPoint[int64]{{Value: 1}},
		metricdatatest.IgnoreTimestamp())
