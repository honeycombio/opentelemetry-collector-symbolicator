...
func Meter(settings component.TelemetrySettings) metric.Meter {
	return settings.MeterProvider.Meter("github.com/honeycombio/opentelemetry-collector-symbolicator/dsymprocessor")
}

func Tracer(settings component.TelemetrySettings) trace.Tracer {
	return settings.TracerProvider.Tracer("github.com/honeycombio/opentelemetry-collector-symbolicator/dsymprocessor")
}
...
type TelemetryBuilder struct {
	...
	ProcessorDsymCacheSize          metric.Int64Gauge
	ProcessorSymbolicationDuration  metric.Float64Histogram
	ProcessorTotalDsymFetchFailures metric.Int64Counter
